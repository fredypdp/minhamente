    ...
    <div class="cadastro-area">
        ...
        <form @submit.prevent="criar" class="cadastro-form" ref="form">
            <div class="avatar-area">
                ...
                <input type="file" accept="image/png,image/jpg,image/jpeg,image/svg+xml" name="avatar" id="foto-cadastro" @change="ShowAvatar" ref="avatarRef" class="avatar-input">
            </div>
...
async function criar(): Promise<void> {
    ...
    try {
        ...
        // Fazendo login
        await login(usuarioCriado.data.usuario.email, senha.value)
