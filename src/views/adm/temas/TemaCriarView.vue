<template>
<div id="TemaCriarView">
    <NavBar/>
    <div class="criar-tema-area">
        <form class="criar-tema-form" @submit.prevent="criar">
...
async function criar(){
    ...
    let config = {
        ...
        data: {
            titulo: titulo.value,
            assunto: AssuntoSelecionado.value,
        }
    };
